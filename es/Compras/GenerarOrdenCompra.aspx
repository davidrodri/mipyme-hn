<%@ Page Title="" Language="C#" MasterPageFile="~/es/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="GenerarOrdenCompra.aspx.cs" Inherits="MiPymes_V2.es.Compras.GenerarOrdenCompra" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0" data-widget-editbutton="false">
                    <header>
                        ...
                        <h2>Información de Ordenes de Compra</h2>
                    </header>
                                ...
                                <dx:BootstrapFormLayout runat="server">
                                    <Items>
                                        ...
                                        <dx:BootstrapLayoutItem Caption="Moneda" ColSpanSm="4">
                                            <ContentCollection>
                                                <dx:ContentControl>
                                                    <dx:ASPxComboBox ID="cboMoneda" Width="100%" HorizontalAlign="Right" Theme="MaterialCompact" runat="server" ValueType="System.String" DataSourceID="dsMonedas" TextField="Nombre" ValueField="MonedaId"></dx:ASPxComboBox>
                                        ...
                                        <dx:BootstrapLayoutItem Caption="" ColSpanSm="2">
                                            <ContentCollection>
                                                <dx:ContentControl>
                                                    <dx:ASPxButton ID="btnBuscarOrdenCompra" runat="server" Text=".." Theme="MaterialCompact" OnClick="btnBuscarOrdenCompra_Click">
	...
	popupOC.Show();
                                ...
                                <dx:ASPxGridView ID="gvGenerarOrdenCompra" runat="server" AutoGenerateColumns="False" Theme="MaterialCompact" KeyFieldName="ID" Width="100%">
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="TotalLinea" ReadOnly="True" VisibleIndex="8">
                                            <DataItemTemplate>
                                                <dx:ASPxSpinEdit ID="spinTotalLinea" runat="server" Number="0" Value='<%# Bind("TotalLinea") %>' Theme="MaterialCompact" Width="100%" DisplayFormatString="n2">
                                                    <SpinButtons ClientVisible="False">
                                                    </SpinButtons>
                                                    <Border BorderStyle="None" />
                                                </dx:ASPxSpinEdit>
        ...
        <div>
            ...
            <dx:ASPxPopupControl ID="popupOC" runat="server" ClientInstanceName="popupOC" Width="800px" AllowResize="True" CloseAction="CloseButton" CloseAnimationType="Slide" HeaderText="Orden de Compra" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" Theme="MaterialCompact">
                <ContentCollection>
                    <dx:PopupControlContentControl runat="server">
                        <table class="nav-justified">
                            ...
                            <tr>
                                <td>
                                    <dx:ASPxDateEdit ID="dFechaInicio" runat="server" Theme="MaterialCompact">
                                    </dx:ASPxDateEdit>
                                </td>
                                <td>
                                    <dx:ASPxDateEdit ID="dFechaFin" runat="server" Theme="MaterialCompact">
                                    </dx:ASPxDateEdit>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <dx:ASPxButton ID="btnBuscarOC" runat="server" OnClick="btnBuscarOC_Click" Text="Buscar" Theme="MaterialCompact">
                                    </dx:ASPxButton>
                                </td>
                            </tr>
                        </table>
                        <div>
                            ...
                            <dx:ASPxGridView ID="gvOrdenCompraBusqueda" runat="server" AutoGenerateColumns="False" DataSourceID="dsOrdenComBusqueda" EnableTheming="True" KeyFieldName="OrdenCompraId" Theme="MaterialCompact">
                                <SettingsBehavior AllowFocusedRow="True" />
                                <Columns>
                                    <dx:GridViewDataTextColumn FieldName="OrdenCompraId" ShowInCustomizationForm="True" VisibleIndex="1">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="SocioNegocioId" ShowInCustomizationForm="True" VisibleIndex="2">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="NombreSocioNegocio" ShowInCustomizationForm="True" VisibleIndex="3">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataDateColumn FieldName="FechaDocumento" ShowInCustomizationForm="True" VisibleIndex="4">
                                    </dx:GridViewDataDateColumn>
                                    <dx:GridViewDataTextColumn FieldName="TotalPagar" ShowInCustomizationForm="True" VisibleIndex="5">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="Ver" ShowInCustomizationForm="True" VisibleIndex="0">
                                        <DataItemTemplate>
                                            <asp:LinkButton ID="lbVer" runat="server" OnClick="lbVer_Click">Ver Orden</asp:LinkButton>
                                        </DataItemTemplate>
                                    </dx:GridViewDataTextColumn>
                                </Columns>
                            </dx:ASPxGridView>
                            <asp:SqlDataSource ID="dsOrdenComBusqueda" runat="server" ConnectionString="<%$ ConnectionStrings:MiPymes_V2.Properties.Settings.MiPymeConnection %>" SelectCommand="SELECT T0.OrdenCompraId,T0.SocioNegocioId, T1.NombreSocioNegocio,FechaDocumento,TotalPagar
FROM OrdenCompra T0
INNER JOIN SociosNegocio T1 
ON T0.SocioNegocioId = T1.SocioNegocioId
WHERE FechaDocumento BETWEEN @FECHAINICIO AND @FECHAFIN and t0.EmpresaId= @EmpresaId
">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="dFechaInicio" Name="FECHAINICIO" PropertyName="Value" />
                                    <asp:ControlParameter ControlID="dFechaFin" Name="FECHAFIN" PropertyName="Value" />
                                    <asp:SessionParameter Name="EmpresaId" SessionField="EmpresaId" />
                                </SelectParameters>
                            </asp:SqlDataSource>
